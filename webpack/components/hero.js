          				...
          				<p className="text-center">I'm a full-stack web developer in Broomfield, Colorado. Currently, I'm focused on building web-based open innovation projects at World That Works.</p>
								...
								<div style={{transitionDelay: '300ms'}}>
									<div className="hero-buttons">
										...
										<a href="https://jim-applegate.ghost.io" target="_blank"><button className="btn btn-default btn-lg"><i className="fa-solid fa-ghost fa-lg"></i>Website</button></a>
										</div>
								</div>
								</CSSTransition>
							</div>
						</div>
						<a className="section-jump text-center" href="#portfolio"><i className="fa-solid fa-angle-down fa-3x"></i></a>
					</div>
				</div>
			</div>
		);
